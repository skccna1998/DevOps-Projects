...
🔗 GitHub Repo: [github.com/skccna1998/DevOps-Projects](https://github.com/skccna1998/DevOps-Projects)
...
| `GET /info` | Welcome to SURESHKUMAR DevOps Class |
| `GET /contact` | Training enquiry contact number |
...
```bash
git clone https://github.com/skccna1998/DevOps-Projects.git
cd DevOps-Projects
```
...
```
https://github.com/skccna1998/DevOps-Projects.git
```
...
def test_sktechopsmobilenumber():
    assert sktechopsmobilenumber() == \
      '<h1 style="color:red;">FOR TRAINING ENQUIRY: +91 9688023053</h1>'
```
